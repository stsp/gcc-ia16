...
#define FUNCTION_PUSH_ARGS_REVERSED(FNTYPE) \
  (! FUNCTION_ARGS_GROW_DOWNWARD (FNTYPE))
#else
#define FUNCTION_PUSH_ARGS_REVERSED(FNTYPE) \
  FUNCTION_ARGS_GROW_DOWNWARD (FNTYPE)
#endif
...
#ifndef FUNCTION_ARGS_GROW_DOWNWARD
#ifdef ARGS_GROW_DOWNWARD
#define FUNCTION_ARGS_GROW_DOWNWARD(FNTYPE) ARGS_GROW_DOWNWARD
#else
#define FUNCTION_ARGS_GROW_DOWNWARD(FNTYPE) 0
#endif
#endif
