...
(define_mode_iterator EQ16P [PHI HI V2QI])
...
(define_insn "*trunchiphi2_via_paradoxical"
  [(set (subreg:HI (match_operand:PHI 0 "nonimmediate_operand" "=T,rm") 0)
	(match_operand:HI 1 "nonimmediate_operand" "rm,Ti"))]
  ""
{
...
(define_expand "push<mode>1"
  [(parallel
  [(set (match_dup 1) (match_operand:EQ16P 0 "general_operand"))
...
(define_insn "_push<mode>1_nonimm"
  [(set (mem:EQ16P (plus:HI (reg:HI SP_REG) (const_int -2)))
	(match_operand:EQ16P 0 "nonimmediate_operand" "Tm"))
   (set (reg:HI SP_REG) (plus:HI (reg:HI SP_REG) (const_int -2)))]
  "!TARGET_PUSH_IMM"
  "pushw\t%0"
)
...
(define_insn "*push<mode>1"
  [(set (mem:EQ16P (plus:HI (reg:HI SP_REG) (const_int -2)))
	(match_operand:EQ16P 0 "general_operand" "Tmi"))
   (set (reg:HI SP_REG) (plus:HI (reg:HI SP_REG) (const_int -2)))]
  "TARGET_PUSH_IMM"
  "pushw\t%0"
)
  ...
  "! fixed_regs[DS_REG]"
{
  ...
  if (! ovr0)
    operands[0] = gen_rtx_MEM (BLKmode, off0);
  else
    {
      operands[0] = gen_rtx_MEM (BLKmode, gen_rtx_PLUS (HImode, off0, ovr0));
      MEM_ADDR_SPACE (operands[0]) = ADDR_SPACE_FAR;
    }
  operands[9] = off0;
  ...
  if (! ovr1)
    operands[1] = gen_rtx_MEM (BLKmode, off1);
  else
    {
      operands[1] = gen_rtx_MEM (BLKmode, gen_rtx_PLUS (HImode, off1, ovr1));
      MEM_ADDR_SPACE (operands[1]) = ADDR_SPACE_FAR;
    }
  operands[10] = off1;
})
...
(define_insn "*movmemhi_far_from_far_const_count<pmrm>"
  [(parallel
    [(set (mem:BLK (plus:HI (match_operand:HI 0 "general_operand" "D")
			    (unspec:HI [(match_operand:SEG 1 "general_operand"
					 "e")] UNSPEC_SEG_OVERRIDE)))
	  (mem:BLK (plus:HI (match_operand:HI 2 "general_operand" "S")
			    (unspec:HI [(match_operand:SEG 3 "general_operand"
					 "Rds")] UNSPEC_SEG_OVERRIDE))))
     (use (match_operand:HI 4 "const_int_operand" "n"))
     (use (match_operand:HI 5 "const_int_operand" "n"))
     (set (match_operand:HI 6 "nonimmediate_operand" "=&0")
	  (match_operand:HI 9 ""))
     (set (match_operand:HI 7 "nonimmediate_operand" "=&2")
	  (match_operand:HI 10 ""))
     (set (match_operand:HI 8 "nonimmediate_operand" "=&c")
	  (match_operand:HI 11 ""))
     (clobber (reg:CC CC_REG))]
  )]
  "optimize > 0"
{
  if (INTVAL (operands[4]) % 2 == 0)
    return "movw\t%W4,\t%8\;cld\;rep; movsw";
  else
    return "movw\t%W4,\t%8\;cld\;rep; movsw\;movsb";
})
...
(define_insn "*movmemhi_far_from_far_nonconst_count<pmrm>"
  [(parallel
    [(set (mem:BLK (plus:HI (match_operand:HI 0 "general_operand" "D")
     ...
     (set (match_operand:HI 7 "nonimmediate_operand" "=&2")
	  (match_operand:HI 10 ""))
     (set (match_operand:HI 8 "nonimmediate_operand" "=&4")
	  (match_operand:HI 11 ""))
     (clobber (reg:CC CC_REG))]
  )]
  ""
{
  if (optimize == 0 || optimize_size)
    ...
    return "cld\;shrw\t$1,\t%4\;rep; movsw\;rclw\t$1,\t%4\;rep; movsb";
})

(define_insn_and_split "*movmemhi_far_from_near<pmrm>"
  [(parallel
    [(set (mem:BLK (plus:HI (match_operand:HI 0 "general_operand")
			    (unspec:HI [(match_operand:SEG 1
							   "general_operand")]
					 UNSPEC_SEG_OVERRIDE)))
	  (mem:BLK (match_operand:HI 2 "general_operand")))
     (use (match_operand:HI 3 "general_operand"))
     (use (match_operand:HI 4 "const_int_operand"))
     (set (match_operand:HI 5 "nonimmediate_operand") (match_operand:HI 8 ""))
     (set (match_operand:HI 6 "nonimmediate_operand") (match_operand:HI 9 ""))
     (set (match_operand:HI 7 "nonimmediate_operand") (match_operand:HI 10 ""))
     (clobber (reg:CC CC_REG))]
  )]
  "! ia16_have_seg_override_p (operands[1])"
  "#"
  ""
  [(parallel
    [(set (mem:BLK (plus:HI (match_dup 0)
			    (unspec:HI [(match_dup 1)] UNSPEC_SEG_OVERRIDE)))
	  (mem:BLK (plus:HI (match_dup 2)
			    (unspec:HI [(match_dup 11)] UNSPEC_SEG_OVERRIDE))))
     (use (match_dup 3))
     (use (match_dup 4))
     (set (match_dup 5) (match_dup 8))
     (set (match_dup 6) (match_dup 9))
     (set (match_dup 7) (match_dup 10))
     (clobber (reg:CC CC_REG))]
  )]
{
  operands[11] = copy_to_reg (gen_rtx_REG (<MODE>mode, SS_REG));
})

(define_insn_and_split "*movmemhi_near_from_far"
  [(parallel
    [(set (mem:BLK (match_operand:HI 0 "general_operand"))
	  (mem:BLK (plus:HI (match_operand:HI 1 "general_operand")
			    (unspec:HI [(match_operand:SEG 2
							   "general_operand")]
				       UNSPEC_SEG_OVERRIDE))))
     (use (match_operand:HI 3 "general_operand"))
     (use (match_operand:HI 4 "const_int_operand"))
  ...
  "! ia16_have_seg_override_p (operands[0])"
  "#"
  ""
  [(parallel
    [(set (mem:BLK (plus:HI (match_dup 0)
			    (unspec:HI [(match_dup 11)] UNSPEC_SEG_OVERRIDE)))
	  (mem:BLK (plus:HI (match_dup 1)
			    (unspec:HI [(match_dup 2)] UNSPEC_SEG_OVERRIDE))))
     (use (match_dup 3))
     (use (match_dup 4))
     (set (match_dup 5) (match_dup 8))
     (set (match_dup 6) (match_dup 9))
...
(define_insn "*call_far_thunked"
	[(call (mem:QI (match_operand:HI 0 "general_operand" "b"))
...
(define_insn "*call_pop_far_thunked"
	[(parallel
	  [(call (mem:QI (match_operand:HI 0 "general_operand" "b,b"))
	         (match_operand:HI 1 "general_operand" "x,x"))
	   (set (reg:HI SP_REG) (plus:HI (reg:HI SP_REG)
					 (match_operand:HI 2 "general_operand"
							     "0,x")))]
	)]
...
(define_insn "*call_value_far_thunked"
	[(set (match_operand 0 "register_operand" "=r")
	      (call (mem:QI (match_operand:HI 1 "general_operand" "b"))
	...
	[(parallel
	  [(set (match_operand 0 "register_operand" "=r,r")
		(call (mem:QI (match_operand:HI 1 "general_operand" "b,b"))
		      (match_operand:HI  2 "general_operand" "x,x")))
	   (set (reg:HI SP_REG) (plus:HI (reg:HI SP_REG)
...
(define_expand "seg16_reloc"
  [(unspec:HI [(match_operand:HI 0 "" "")] UNSPEC_OZSEG16)]
  ""
  ""
)

(define_insn "*movhi_seg16"
  [(set (match_operand:HI 0 "register_operand" "=r")
	(unspec:HI [(match_operand:HI 1 "" "")] UNSPEC_OZSEG16))]
  ""
{
  if (TARGET_ABI_SEGELF)
    return "movw\t$%Z1@SEG,\t%0";
  else
    return "movw\t%1@OZSEG16,\t%0";
})
...
(define_insn "trunchiphi2"
  [(set (match_operand:PHI 0 "nonimmediate_operand" "=T,rm")
	(truncate:PHI (match_operand:HI 1 "nonimmediate_operand" "rm,Ti")))]
  ""
  "movw\t%1,\t%0"
)
...
(define_insn "*movphi_prot_mode_selector"
  [(set (match_operand:PHI 0 "nonimmediate_operand" "=T,rm")
	(match_operand:PHI 1 "general_operand" "rm,Ti"))]
