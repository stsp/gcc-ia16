...
(define_insn "*call"
	...
	"!SIBLING_CALL_P (insn)"
{
  return ia16_get_call_expansion (operands[0], <MODE>mode, false);
})
...
(define_insn "*sibcall"
        ...
        "SIBLING_CALL_P (insn)"
{
  return ia16_get_sibcall_expansion (operands[0], <MODE>mode, false);
})
...
(define_insn "*call_value"
	...
	"!SIBLING_CALL_P (insn)"
{
  return ia16_get_call_expansion (operands[1], <MODE>mode, true);
})
...
(define_insn "*sibcall_value"
        ...
        "SIBLING_CALL_P (insn)"
{
  return ia16_get_sibcall_expansion (operands[1], <MODE>mode, true);
})
