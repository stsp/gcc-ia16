...
(define_expand "abs<mode>2"
  [(set (match_dup 0) (match_operand:MO 1 "general_operand"))
   (set (match_dup 2) (ashiftrt:MO (match_dup 0) (match_dup 3)))
   (parallel [
   (set (match_operand:MO 0 "nonimmediate_operand")
	(xor:MO (match_dup 0) (match_dup 2)))
   (clobber (reg:CC CC_REG))
   ])
   (parallel [
  ...
  ""
{
  ...
  operands[3] = GEN_INT (GET_MODE_BITSIZE (<MODE>mode) - 1);
})
