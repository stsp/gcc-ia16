...
; (Except, we cannot really do add/sub across vector elements...)
(define_code_iterator any_bitwise3 [and ior xor])
(define_code_attr  optab_bitwise3 [(and "and") (ior "ior") (xor "xor")])
(define_code_attr  constr1_bitwise3 [(and "%") (ior "%") (xor "%")])
...
(define_expand "<optab_bitwise3>v2qi3"
  [(parallel
  [(set (match_operand:V2QI 0 "nonimmediate_operand")
	(any_bitwise3:V2QI (match_operand:V2QI 1 "nonimmediate_operand")
  ...
  ""
{
  ...
  if ((tmp = ia16_prepare_operands (<CODE>, operands)))
    {
      emit_insn (gen_<optab_bitwise3>v2qi3 (tmp,
					    operands[1], operands[2]));
      emit_move_insn (operands[0], tmp);
      DONE;
    }
