	...
	"!SIBLING_CALL_P (insn)"
{
  ...
  else if (ia16_far_function_rtx_p (operands[0]))
    {
      if (MEM_P (operands[0]))
	return ("pushw\t%%cs\;call\t*%0");
      else if (CONSTANT_P (operands[0]))
	return ("pushw\t%%cs\;call\t%c0");
      else
	return ("pushw\t%%cs\;call\t*%0");
    }
  else
	...
	"!SIBLING_CALL_P (insn)"
{
  ...
  else if (ia16_far_function_rtx_p (operands[1]))
    {
      if (MEM_P (operands[1]))
	return ("pushw\t%%cs\;call\t*%1");
      else if (CONSTANT_P (operands[1]))
	return ("pushw\t%%cs\;call\t%c1");
      else
	return ("pushw\t%%cs\;call\t*%1");
    }
  else
