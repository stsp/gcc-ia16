  ...
  "! fixed_regs[DS_REG]"
{
  ...
  if (! ovr0)
    ovr0 = ia16_seg_override_term (copy_to_reg (gen_rtx_REG (SEGmode,
							     SS_REG)));
  ...
  if (! ovr1)
    ovr1 = ia16_seg_override_term (copy_to_reg (gen_rtx_REG (SEGmode,
							     SS_REG)));
...
(define_expand "seg16_reloc<pmrm>"
  [(unspec:HI [(match_operand:SEG 0 "" "")] UNSPEC_OZSEG16)]
  ""
  ""
)
