...
(define_insn "*movmemhi_far_from_far_const_count"
  [(parallel
    [(set (mem:BLK (plus:HI (match_operand:HI 0 "general_operand" "D")
			    (unspec:HI [(match_operand:HI 1 "general_operand"
					 "e")] UNSPEC_SEG_OVERRIDE)))
	  (mem:BLK (plus:HI (match_operand:HI 2 "general_operand" "S")
			    (unspec:HI [(match_operand:HI 3 "general_operand"
...
(define_insn "*movmemhi_far_from_far_nonconst_count"
  [(parallel
    [(set (mem:BLK (plus:HI (match_operand:HI 0 "general_operand" "D")
			    (unspec:HI [(match_operand:HI 1 "general_operand"
					 "e")] UNSPEC_SEG_OVERRIDE)))
...
(define_insn_and_split "*movmemhi_far_from_near"
  [(parallel
...
{
  operands[11] = copy_to_reg (gen_rtx_REG (HImode, SS_REG));
})
  ...
  [(parallel
    [(set (mem:BLK (match_operand:HI 0 "general_operand"))
	  (mem:BLK (plus:HI (match_operand:HI 1 "general_operand")
			    (unspec:HI [(match_operand:HI 2 "general_operand")]
				       UNSPEC_SEG_OVERRIDE))))
     (use (match_operand:HI 3 "general_operand"))
     (use (match_operand:HI 4 "const_int_operand"))
     (set (match_operand:HI 5 "nonimmediate_operand") (match_operand:HI 8 ""))
