...
extern int		ia16_restore_ds_function_type_p (const_tree funtype);
extern int		ia16_ss_data_function_type_p (const_tree funtype);
extern int		ia16_ds_data_function_rtx_p (rtx);
extern int		ia16_restore_ds_function_rtx_p (rtx);
extern int		ia16_in_ds_data_function_p (void);
extern int		ia16_in_restore_ds_function_p (void);
