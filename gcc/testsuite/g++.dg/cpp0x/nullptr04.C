...
const short int n5 = reinterpret_cast<short int>(nullptr); // { dg-error "loses precision" "" { target { ! ia16-*-* } } }
...
const short int n9 = reinterpret_cast<short int>(mynull); // { dg-error "loses precision" "" { target { ! ia16-*-* } } }
